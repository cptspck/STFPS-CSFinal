...
*****************************************/
   ...
   public void turnAbs(double a){
      ...
      dY = oldDX * Math.sin(-a) + dY * Math.cos(-a);
      double oldDX2 = dX2;
      dX2 = dX2 * Math.cos(-a) - dY2 * Math.sin(-a);
      dY2 = oldDX2 * Math.sin(-a) + dY2 * Math.cos(-a);
      while(myDir >= (2*Math.PI)){
         myDir -= (2*Math.PI);
      }
      while(myDir <= 0){
...
*****************************************/
   ...
   public boolean shouldLevel(){
      if(readyToLevel){
         System.out.println("planeX: " + planeX + "\t| planeY: " + planeY);
         return true;
      }
      return false;
   }
